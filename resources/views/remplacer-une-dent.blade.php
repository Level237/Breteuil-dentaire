            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Remplacer</span> une
                            Dent</h1>
                    ...
                    <div class="techonology-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Nos docteurs et notre équipe établiront avec vous
                                un bilan clinique général et bucco-dentaire.Si cela est nécessaire, une radiographie ou
                                éventuellement un scanner dentaire 3D seront à prévoir. Après cet examen, nous vous
                                remettons un plan de traitement prothétique et chirurgical.</p>
                        </div>
                        <!-- Section Title End -->
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="techonology-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-2" data-cursor="-opaque"><span>2-Mise en place </span> de l’implant
                                dentaires</h2>
                            <p class="wow fadeInUp" data-wow-delay="0.25s">La mise en place s’effectue sous anesthésie
                                locale et lorsque cela s’avère possible une dent provisoire est mise en place.
                                Le temps de l’ostéointégration peut varier en fonction de chacun. En moyenne la pose d’une
                                couronne dentaire intervient dans les trois à six mois.</p>
                        </div>
                        <!-- Section Title End -->
                    </div>
                    <!-- Techonology Content End -->
