        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Remplacer</span> toutes ces Dents</h1>
                    <nav class="wow fadeInUp">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('homepage') }}" style="color:#8b8b8b">home</a></li>
                            <li class="breadcrumb-item active text-white" aria-current="page">Remplacer toutes ces dents</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
            ...
            <div class="col-lg-6">
                ...
                <div class="techonology-content">
                    ...
                    <div class="section-title">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.25s">Nos docteurs et notre équipe établiront avec vous un bilan clinique général et bucco-dentaire.

                            Si cela est nécessaire, une radiographie ou éventuellement un scanner dentaire 3D seront à prévoir. Un plan de traitement prothétique et chirurgical vous sera remis après cet examen.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="techonology-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque"><span>2- Mise en place des   </span> implants dentaires</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.25s">La mise en place se fait sous anesthésie locale, un appareil provisoire est vissé sur les implants dentaire.
                            Le temps de la cicatrisation osseuse peut varier en fonction de chacun. En moyenne, la pose d’un bridge complet définitif sur implant intervient dans les 3 à 6 mois qui suivent.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
                <!-- Techonology Content End -->
        ...
        <div class="row techonology-item align-items-center">
            <div class="col-lg-6">
                ...
                <div class="techonology-image-box">
                    ...
                    <div class="techonology-image-1">
                        <figure class="image-anime reveal">
                            <img src="{{ asset('assets/images/Pose-d-un-bridge-complet-sur-implants-dentaires-All-on-6.jpg') }}" alt="">
                        </figure>
                    </div>
                    <!-- Techonology Image End -->
            ...
            <div class="col-lg-6">
                ...
                <div class="techonology-content">
                    ...
                    <div class="section-title">
                        ...
                        <p style="margin-bottom: 12px" class="wow fadeInUp" data-wow-delay="0.25s">Après un contrôle de la cicatrisation osseuse de <a href="{{ route('implant-dentaire') }}"> l’implant dentaire</a> , c’est la dernière étape du traitement.

                            Vous pourrez faire le choix de différents bridges sur <a href="{{ route('implant-dentaire') }}"> l’implant dentaire</a> :</p>
            ...
            <div class="service-entry" style="margin-top:100px">
                ...
                <p class="wow fadeInUp" data-wow-delay="0.2s">Le système All-on-6 se développe durant les années 1990 afin d’offrir une option de traitement simple pour le patient. Ce système est particulièrement utile dans le traitement du maxillaire supérieur en permettant d’y insérer de plus longs implants et en éliminant le besoin de greffe osseuse et fut développé par le Dr Paulo Malo en Europe. L’objectif est de mettre en place une prothèse fixe sur implant en une seule journée.</p>

                <p class="wow fadeInUp" style="margin-top: 12px">Avec l’approche All-on-6 le patient n’est jamais sans dents.</p>
                <p class="wow fadeInUp" style="margin-top: 12px">Le patient devra revenir pour des contrôles durant les semaines qui suivront l’intervention.</p>
                <p class="wow fadeInUp" style="margin-top: 12px">Lprès une cicatrisation de 4 à 6 mois, une fois les implants bien fusionnés à l’os, des empreintes seront prises et une prothèse finale sera confectionnée. Finalement, Cette prothèse est tout aussi belle que la première et elle est plus solide et durable. Cette nouvelle prothèse permettra de retrouver les fonctions esthétiques et masticatoires pour de nombreuses années.</p>
            ...
            <div class="col-lg-6">
                ...
                <div class="contact-now-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque"><span>Obtenir une consultation</span>pour remplacer une dent</h2>
                    </div>
                    <!-- Section Title End -->
