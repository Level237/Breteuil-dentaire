...
@section('main')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Implant</span>
                            Dentaire</h1>
    ...
    <div class="mt-6" style="display: flex;align-items:center;justify-content:center;margin-top:50px">
        <p class="text-center w-50 wow fadeInUp">L’implantologie dentaire permet de remplacer des dents, mais ce n’est pas
            seulement un acte esthétique. Cela permet aussi de retrouver un bien-être certain aux patients souffrant de la
            perte d’une ou plusieurs dents.</p>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="service-single-content">
                        ...
                        <div class="service-entry">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Un implant dentaire est comme une petite vis,
                                c’est une racine artificielle, il est en titane et biocompatible. Il sert à remplacer la
                                racine d’une dent abîmée ou manquante. Il permet de servir de point d’ancrage à une future
                                prothèse dentaire ou couronne céramique. Que ce soit pour une ou plusieurs dents manquantes
                                nous vous proposerons la solution la mieux adaptée à votre cas. Obtenez un résultat optimal
                                à la fois esthétique et fiable dans le temps.</p>

                            <p class="wow fadeInUp" style="margin-top: 12px">Grâce à l’implant dentaire, votre nouvelle dent
                                aura l’apparence et l’efficacité d’une dent naturelle saine.</p>
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Parce que à long terme, c’est une solution qui
                                permet de remplacer en toute sécurité une ou plusieurs dents sans affecter les autres dents,
                                ce qui en fait la meilleure solution pour remplacer les dents manquantes :</p>
                            <div class="wow fadeInUp row" data-wow-delay="1s">
                                ...
                                <li style="margin-bottom: 12px">
                                    Les implants dentaires empêchent une fonte osseuse importante et l’affaissement du
                                    visage à l’origine de son vieillissement prématuré.</li>
                                <li style="margin-bottom: 12px">
                                    La pose d’implant dentaire évite le délabrement des dents naturelles voisines de
                                    l’édentation, contrairement aux techniques traditionnelles.</li>
                                <li style="margin-bottom: 12px">Ils offrent une base stable pour les nouvelles dents, et
                                    permettent de parler et de manger avec confort en toute sécurité</li>
                                <li style="margin-bottom: 12px">ILes implants dentaires constituent une solution extrêmement
                                    prévisible, avec des études sur le moyen et le long terme montrant des taux très élevés
                                    de réussite.</li>
                                </ul>
                            </div>
