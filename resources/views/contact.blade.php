                    ...
                    <div class="contact-form">
                        ...
                        <form action="{{ route('send.contact') }}" method="POST" data-toggle="validator"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-4">
                                    <input type="text" name="subject" class="form-control" id="subject" placeholder="Object"
                                        required="">
                                    <div class="help-block with-errors"></div>
                                </div>

                                <div class="form-group col-md-12 mb-5">
                                    <textarea name="msg" class="form-control" id="msg" rows="5" placeholder="Votre message"
                                        required=""></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="contact-us-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Pour des soins dentaires d'urgence ou pour
                                prendre rendez-vous, contactez notre cabinet à l'adresse suivante : visitez notre clinique.
                            </p>
                        </div>
                        <!-- Section Title End -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="google-map">
                        ...
                        <div class="google-map-iframe">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2584.2532807672974!2d2.2936805757851797!3d49.63068077144725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e7a2ff056390f3%3A0x12a1c5ad36db7e1c!2s5%20bis%20Rue%20Tassart%2C%2060120%20Breteuil%2C%20France!5e0!3m2!1sfr!2scm!4v1735156150881!5m2!1sfr!2scm"
