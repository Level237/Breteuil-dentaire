            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="service-sidebar">
                        ...
                        <img style="width: 80%;margin-top:22px" src="{{ asset('assets/images/Facette-pelliculaire2.png') }}"
                            alt="">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="service-single-content">
                        ...
                        <div class="service-entry">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Les facettes pelliculaires sont considérées
                                unanimement comme « la » référence des céramiques dentaires. Elles bénéficient d’une qualité
                                cosmétique et d’une résistance éprouvées et pérennes.

                                .</p>

                            <p class="wow fadeInUp" style="margin-top: 12px">Les facettes pelliculaires sont les facettes
                                pelliculaires les plus fines du marché. Aussi fines qu’une lentille de contact, elles
                                permettent de couvrir la zone du sourire de l’arcade supérieure ou inférieure.</p>

                            <p class="wow fadeInUp" style="margin-top: 12px">Au laboratoire, nous confectionnons la facette
                                pelliculaire. Le travail à réaliser étant défini, le praticien peut être amené à réaliser ou
                                non une taille à minima des dents. Puis, nous effectuons une empreinte, réalisons des dents
                                provisoires et adaptons sur les dents.</p>



                            <p class="wow fadeInUp" style="margin-top: 12px">Dans un délai de prés d’une semaine, les
                                facettes sont prêtes. Elles peuvent alors être posées et collées lors de cette seconde
                                séance.</p>
