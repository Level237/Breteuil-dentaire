        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Dentisterie</span> Numérique</h1>
            ...
            <div class="col-lg-8">
                ...
                <div class="service-single-content">
                    ...
                    <div class="service-entry">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="0.2s">Les nouvelles technologies et l’intelligence artificielle ont bouleversé la médecine dentaire.
                            Dans notre cabinet, vous pourrez ainsi bénéficier de soins de dernière génération. Grâce à nos systèmes d’empreintes numérique et de conception et « impression 3D », obtenez des soins d’une grande fiabilité et d’une grande précision.

                            .</p>

                        <p class="wow fadeInUp" style="margin-top: 12px">Ainsi, il devient alors possible de vous faire des couronnes ou inlays en une seule séance !</p>
            ...
            <div class="col-lg-6">
                ...
                <div class="contact-now-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque"><span>Obtenir une consultation</span>pour une dentisterie numérique</h2>
                    </div>
                    <!-- Section Title End -->
