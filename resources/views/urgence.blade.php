...
@section('main')
    <div class="page-header"
        style="background-image: url({{ asset('assets/images/urgences.jpg') }});background-size:cover;height:100%;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <!-- Page Header Box Start -->
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Urgences</span>
                            Dentaires</h1>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="techonology-content">
                        ...
                        <div class="section-title">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.25s">Parce que c’est bien connu, les douleurs
                                bucco-dentaires sont parmi les plus insupportables, nous nous organisons quotidiennement,
                                pour prendre en charge les urgences douloureuses et fonctionnelles.</p>
                        </div>
                        <!-- Section Title End -->
                    </div>
