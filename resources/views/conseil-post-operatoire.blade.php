...
@section('main')
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Conseils </span>
                            Post-operatoires</h1>
    ...
    <div class="mt-6" style="display: flex;align-items:center;justify-content:center;margin-top:50px">
        <p class="text-center w-50 wow fadeInUp">Vous venez de recevoir la mise en place d’un ou plusieurs <a
                href="{{ route('implant-dentaire') }}">implants dentaires.</a> Les suites opératoires sont simples voire
            inexistantes, si la prémédication a été correctement suivie.</p>
    </div>
                    ...
                    <div class="service-single-content">
                        ...
                        <div class="service-entry">
                            ...
                            <li style="margin-bottom: 15px">
                                Prendre impérativement tous les médicaments prescrits, même s’il n’y a pas de douleur : Une
                                douleur installée est difficile à combattre.</li>

                            <li class="">


                                Prendre les antalgiques prescrits à intervalle régulier de 2 ou 4 heures après
                                l’intervention.</li>
                            <li style="margin-bottom: 15px">

                                Mettre une poche de glace, sur la joue en permanence le jour de l’intervention et le plus
                                longtemps possible.</li>
                            <li style="margin-bottom: 15px">

                                Après la dépose des sutures brosser doucement le site d’intervention et les vis avec une
                                brosse</li>
                            ...
                            <div class="row no-gutters">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <li style="margin-bottom: 15px">
                                        ...
                                        Ne pas toucher ou manger sur le/les implant(s) dentaire(s)les 6 premières semaines.
                                    </li>
                                ...
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <h3 class="wow fadeInUp text-center">N’hésitez pas à prendre contact avec le cabinet
                                            dentaire si :</h3>
                                        <li style="margin-bottom: 15px">
                                        ...
                                        <p class="wow fadeInUp" style="margin-top: 12px">Merci de suivre ces quelques
                                            conseils qui sont d’ordre général et ne peuvent prévaloir sur ce que votre
                                            chirurgien dentiste à pu vous prescrire / conseiller. Ces conseils vous aideront
                                            à mieux supporter les suites postopératoires, et à améliorer le succès du
