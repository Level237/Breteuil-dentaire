        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-header-box">
                    <h1 class="text-anime-style-2" data-cursor="-opaque"><span class="text-white">Remplacer</span> plusieurs Dents</h1>
                    <nav class="wow fadeInUp">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('homepage') }}" style="color:#8b8b8b">home</a></li>
                            <li class="breadcrumb-item active text-white" aria-current="page">Remplacer plusieurs dents</li>
                        </ol>
                    </nav>
                </div>
                <!-- Page Header Box End -->
            ...
            <div class="col-lg-6">
                ...
                <div class="techonology-content">
                    ...
                    <div class="section-title">
                        ...
                        <h2 class="text-anime-style-2" data-cursor="-opaque"><span>2- Pose des  </span> implants dentaires</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.25s">Après la pose des implants dentaires, et lorsque le cas est favorable et choisi, les docteurs et son équipe pourront mettre en place pour des raisons esthétiques un bridge provisoire.

                            Le temps de la cicatrisation osseuse peut varier en fonction de chacun, en moyenne et dans l’ensemble, la pose d’un bridge céramique définitif intervient dans les quatre mois.</p>
                    </div>
                    <!-- Section Title End -->
                </div>
                <!-- Techonology Content End -->
