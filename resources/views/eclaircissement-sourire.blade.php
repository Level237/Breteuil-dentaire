...
@section('main')
    <div class="page-header"
        style="background-image: url({{ asset('assets/images/teeth-5120231_640-dark.jpg') }});background-size:cover;height:100%;background-position:bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    <div class="service-featured-image container" style="margin-top: 110px;">
        ...
        <p class="wow fadeInUp" style="margin-top:35px" data-wow-delay="0.2s">La couleur des dents peut évoluer suite à une
            maladie. Mais aussi à des prises de médicaments au vieillissement ou tout simplement selon votre patrimoine
            génétique.
            La forme de la dentition, l’implantation dentaire peut avoir subi des agressions, ou n’être pas idéale
            médicalement parlant.

            Selon votre souhait, nous pouvons vous proposer des solutions dans 95% des cas, sans chirurgie lourde, pour
            retrouver confort et esthétique selon vos souhaits.</p>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="service-single-content">
                        ...
                        <div class="service-entry">
                            ...
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Votre sourire est notre préoccupation. Nos
                                docteurs et son équipe proposent un ensemble d’opérations vous permettant de retrouver un
                                sourire éblouissant. Mais aussi une bouche éclatante de santé.

                                .</p>

                            <p class="wow fadeInUp" style="margin-top: 12px">Les principaux avantages d’une couronne
                                céramique sur zircone sont :</p>
                            ...
                            <ul>
                                ...
                                <p class="wow fadeInUp ">aucune apparition de liserés gris dans le temps car il n’y pas de
                                    métal, innocuité avec la cavité buccale en opposition avec les couronnes
                                    céramo-métalique.</p>
                                <li class="text-primary">

                                    Sa résistance</li>
                                <p class="wow fadeInUp ">elle est toute aussi résistante voire plus qu’une céramo-métallique
                                    sur Or, chrome-cobalt ou tout autre alliage.</p>

                                <li class="text-primary">


                                    Son esthétique</li>
                                <p class="wow fadeInUp ">du fait que la zircone est blanche, elle est plus adaptée pour
                                    servir de support à une couronne dentaire en céramique.</p>
                            </ul>

                            <div class="wow fadeInUp row" data-wow-delay="1s">
                                <p class="wow fadeInUp ">La zircone favorise la ‘fibrointégration’ avec la gencive. Celle-ci
                                    aime particulièrement bien la zircone en comparaison au métal (pas de liserés gris).</p>
                                <p class="wow fadeInUp ">Les bridges en zircone possèdent les mêmes propriétés techniques
                                    que celles des couronnes céramiques en zircone, esthétique, résistance et
                                    biocompatibilité.</p>
                                <p class="wow fadeInUp ">Nous fabriquons nos Couronnes et Bridges dentaire tout céramique
                                    (chape Zircone ou Alumine) à partir du Système Nobel Procera, conception en 3D sur
                                    ordinateur.</p>
